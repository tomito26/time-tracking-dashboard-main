<template>
  <div class="container">
    <the-header
      @show-daily-cmp="showDailyCmp"
      @show-weekly-cmp="showWeeklyCmp"
...
export default {
  ...
  data() {
    return {
      displayComponent: "daily-activities",
      activities: [
        {
          id: 1,
          title: "Work",
  ...
  methods: {
    showDailyCmp(cmponent) {
      this.displayComponent = cmponent;
    },
    showMonthlyCmp(cmponent) {
      this.displayComponent = cmponent;
    },
    showWeeklyCmp(cmponent) {
      this.displayComponent = cmponent;
    },
  },
};
